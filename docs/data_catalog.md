...
The `gold.fact_sales` table connects to the dimension tables through their surrogate keys:
...
This structure allows business users and analytical tools to efficiently analyze sales by **customer, product, category, geography, demographics, and time**.
